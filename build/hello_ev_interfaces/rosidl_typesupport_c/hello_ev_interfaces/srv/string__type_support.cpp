...
#include "hello_ev_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _String_Request_type_support_symbol_names_t _String_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hello_ev_interfaces, srv, String_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hello_ev_interfaces, srv, String_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hello_ev_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hello_ev_interfaces, srv, String_Request)() {
  return &::hello_ev_interfaces::srv::rosidl_typesupport_c::String_Request_message_type_support_handle;
}
...
static const _String_Response_type_support_symbol_names_t _String_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hello_ev_interfaces, srv, String_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hello_ev_interfaces, srv, String_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hello_ev_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hello_ev_interfaces, srv, String_Response)() {
  return &::hello_ev_interfaces::srv::rosidl_typesupport_c::String_Response_message_type_support_handle;
}
...
static const _String_type_support_symbol_names_t _String_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hello_ev_interfaces, srv, String)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hello_ev_interfaces, srv, String)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hello_ev_interfaces, srv, String)() {
  return &::hello_ev_interfaces::srv::rosidl_typesupport_c::String_service_type_support_handle;
}
