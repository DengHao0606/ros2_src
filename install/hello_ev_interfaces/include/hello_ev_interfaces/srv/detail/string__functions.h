...
#ifndef HELLO_EV_INTERFACES__SRV__DETAIL__STRING__FUNCTIONS_H_
#define HELLO_EV_INTERFACES__SRV__DETAIL__STRING__FUNCTIONS_H_
...
#include "hello_ev_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_hello_ev_interfaces
bool
 ...
 * calls
 * hello_ev_interfaces__srv__String_Request__init().
...
/**
 * It calls
 * hello_ev_interfaces__srv__String_Request__fini()
 ...
 * hello_ev_interfaces__srv__String_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * hello_ev_interfaces__srv__String_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hello_ev_interfaces__srv__String_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hello_ev_interfaces
...
/**
 * It calls
 * hello_ev_interfaces__srv__String_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hello_ev_interfaces
...
/**
 * It allocates the memory for the array and calls
 * hello_ev_interfaces__srv__String_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hello_ev_interfaces
...
/**
 * It calls
 * hello_ev_interfaces__srv__String_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HELLO_EV_INTERFACES__SRV__DETAIL__STRING__FUNCTIONS_H_
